...
async function initDb() {
  ...
  const tgNotifyMode = await Setting.findOne({ where: { setting_key: 'telegram_notify_mode' } });
  ...
  if (tgNotifyMode) process.env.TELEGRAM_NOTIFY_MODE = tgNotifyMode.setting_value;
